...
<div>
    ...
    <transition name="el-fade-in-linear" mode="out-in">
        <div style="text-align: center;margin: 0 20px;height: 100%" v-if="active === 0">
            <div style="margin-top: 80px">
                ...
                <div style="font-size: 14px;color: grey">Enter your email to reset password</div>
            </div>
                    ...
                    <el-form-item prop="code">
                        <el-row style="width: 100%">
                            ...
                            <el-col :span="12" style="margin-left: 12px;">
                                <el-button type="success" @click="validateEmail" style="width: 100%;" :disabled="!isEmailValid || coldTime > 0">
    ...
    <transition name="el-fade-in-linear" mode="out-in">
        <div style="text-align: center;margin: 0 20px;height: 100%" v-if="active === 1">
            <div style="margin-top: 80px">
                <div style="font-size: 25px;font-weight: bold">Reset Password</div>
                <div style="font-size: 14px;color: grey">Please fill in your new password and be sure to remember it to prevent loss</div>
            </div>
            ...
            <div style="margin-top: 50px">
                <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
                    ...
                    <el-form-item prop="password_repeat">
                        <el-input v-model="form.password_repeat" :maxlength="20" type="password" placeholder="Repeat new password">
                            <template #prefix>
                                <el-icon>
                                    <Lock />
                                </el-icon>
