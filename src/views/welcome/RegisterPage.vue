...
<div style="text-align: center; margin: 0 20px">
    ...
    <div style="margin-top: 50px">
        <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
            <el-form-item prop="username">
                <el-input v-model="form.username" :maxlength="20" type="text" placeholder="Username">
                    <template #prefix>
                        <el-icon>
                            <User />
                        </el-icon>
            ...
            <el-form-item prop="email">
                <el-input v-model="form.email" :maxlength="50" type="email" placeholder="Email address">
                    <template #prefix>
                        <el-icon>
                            <Message />
                        </el-icon>
    ...
    <div style="margin-top: 80px">
        <el-button style="width: 270px" type="warning" @click="register" plain>Sign Up</el-button>
    </div>
